    ...
    <DashboardLayout title="My Courses">
      ...
      <div className="mb-6 flex flex-col md:flex-row gap-4 items-center justify-between">
        <div className="relative w-full md:max-w-md">
          ...
          <input
            type="search"
            className="w-full rounded-lg border border-gray-200 pl-10 pr-4 py-2.5 text-sm text-gray-700 focus:border-blue-500 focus:outline-none  focus:ring-blue-500"
        ...
        <div className="flex items-center w-full md:w-auto">
          ...
          <select
            id="sortBy"
            className="w-full md:w-auto rounded-lg border border-gray-200 py-2.5 pl-3 pr-8 text-sm text-gray-700 focus:border-blue-500 focus:outline-none  focus:ring-blue-500"
            value={sortBy}
