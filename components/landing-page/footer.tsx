const Footer = () => {
  return (
    <footer className="bg-gray-900 sm:px-0 lg:px-20 py-12 text-white">
      <div className="container mx-auto px-4">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 className="mb-4 text-xl font-bold">ITCA</h3>
            <p className="mb-4 text-gray-400">
              Information Technology Communication Association under the School
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <span className="text-gray-400">
                  University Campus, Building 4, Floor 2
                </span>
              </li>
              <li className="flex items-start">
                <svg
                ...
                <span className="text-gray-400">info@itca.edu</span>
              </li>
              <li className="flex items-start">
                <svg
                  className="mr-2 h-5 w-5 shrink-0 text-itca-gold"
