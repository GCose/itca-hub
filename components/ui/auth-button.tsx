...
const AuthButton = ({
    ...
    return (
      <button
        ...
        className={`group relative ${
          fullWidth ? "w-full" : ""
        } py-3 px-4 border-0 rounded-lg text-white bg-blue-700 hover:bg-blue-700 focus:outline-none transition-colors disabled:opacity-70 overflow-hidden ${className}`}
      >
  ...
  return (
    <button
      ...
      className={`${
        fullWidth ? "w-full" : ""
      } py-3 px-4 border border-gray-300 rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none transition-colors disabled:opacity-70 ${className}`}
    >
