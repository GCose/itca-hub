...
const Sidebar = ({ open, setOpen }: SidebarProps) => {
  ...
  return (
    <>
      ...
      {/*==================== Sidebar ====================*/}
      <div
        className={`fixed rounded-tr-4xl rounded-tb-4xl inset-y-0 z-50 w-60 transform overflow-hidden max-[968px]:bg-white lg:bg-white transition-transform ease-in-out duration-300 
