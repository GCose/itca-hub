      ...
      <div className="rounded-lg border border-gray-200 bg-white p-5 shadow-sm">
        <div className="mb-5 flex flex-col md:flex-row gap-4">
          ...
          <div className="w-full md:w-auto">
            <select
              className="w-full md:w-32 rounded-lg border border-gray-200 py-2.5 pl-3 pr-8 text-sm text-gray-700 focus:border-blue-500 focus:outline-none  focus:ring-blue-500"
