  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      {Array.from({ length: 6 }).map((_, index) => (
        ...
        >
          {/*==================== Image Skeleton ====================*/}
          <div className="aspect-video w-full bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 animate-pulse" />
          ...
          <div className="p-6">
            ...
            <div className="mb-4 flex items-start justify-between">
              ...
              <div className="ml-3 flex space-x-1">
                <div className="h-8 w-8 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded-md animate-pulse" />
                <div className="h-8 w-8 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded-md animate-pulse" />
              </div>
            ...
            <div className="space-y-4 text-sm text-gray-500 mb-4">
              ...
              <div className="flex items-center space-x-2">
                <div className="h-4 w-4 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded animate-pulse" />
                <div className="h-4 w-24 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded animate-pulse" />
              </div>
              {/*==================== End of Time ==================== */}
              ...
              <div className="flex items-center space-x-2">
                <div className="h-4 w-4 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded animate-pulse" />
                <div className="h-4 w-36 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded animate-pulse" />
              </div>
              {/*==================== End of Location ==================== */}
            ...
            <div className="mt-4 pt-4 border-t border-gray-100">
              <div className="h-10 w-full bg-gradient-to-r from-gray-100 via-gray-200 to-gray-100 rounded-lg animate-pulse" />
            </div>
